...
const OPTIONS: ModeOption[] = [
  {
    mode: 'app',
    title: 'Uninstall Reuben Desktop',
    description: 'Remove this desktop app. The configured remote backend and its data stay untouched.',
    consequence: 'the Reuben Desktop app bundle only'
  }
]
      ...
      <div className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3">
        {loading ? (
          ...
          <div className="flex flex-col gap-2">
            <p className="text-sm font-medium">Uninstall Reuben</p>
            <p className="text-xs text-muted-foreground">
              Reuben Desktop is only the frontend. Remote gateway and backend data are managed separately.
            </p>
