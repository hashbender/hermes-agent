...
export const zh: Translations = {
  ...
  boot: {
    ...
    failure: {
      ...
      openLogs: '打开日志',
      repairHint: '配置远程 Hermes 网关 URL，然后重试连接。',
      remoteSignInHint: '打开网关登录窗口。你也可以在设置中更新网关 URL 或令牌。',
