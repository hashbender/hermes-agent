...
| [**mind**](/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-mind) | Brain-like project memory for agents: spreading-activation recall, Ebbinghaus forgetting, deterministic dream consolidation, and export to AGENTS.md/CLAUDE.md/GEMINI.md. One Python file, zero dependencies, zero API keys, fully offline, b... |
