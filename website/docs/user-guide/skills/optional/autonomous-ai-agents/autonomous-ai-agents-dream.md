...
title: "Dream"
sidebar_label: "Dream"
description: "Deterministic sleep-cycle consolidation for the agent's own memory files: dedup, supersession, contradiction flags, and hard char-budget squeeze for MEMORY"
---
...
Deterministic sleep-cycle consolidation for the agent's own memory files: dedup, supersession, contradiction flags, and hard char-budget squeeze for MEMORY.md/USER.md. Zero LLM calls, zero tokens, dry-run first, never deletes (archives with reasons). One Python file, zero dependencies.
