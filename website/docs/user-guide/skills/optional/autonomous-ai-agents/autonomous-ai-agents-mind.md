...
title: "Mind"
sidebar_label: "Mind"
description: "Brain-like project memory for agents: spreading-activation recall, Ebbinghaus forgetting, deterministic dream consolidation, and export to AGENTS"
---
...
Brain-like project memory for agents: spreading-activation recall, Ebbinghaus forgetting, deterministic dream consolidation, and export to AGENTS.md/CLAUDE.md/GEMINI.md. One Python file, zero dependencies, zero API keys, fully offline, bilingual (EN/AR).
