...
class TestResolveCommand:
    ...
    def test_alias_resolves_to_canonical(self):
        ...
        assert resolve_command("mcp_status").name == "mcpstatus"
        assert resolve_command("mcp-status").name == "mcpstatus"
        assert resolve_command("mcp_doctor").name == "mcpdoctor"
        assert resolve_command("mcp-doctor").name == "mcpdoctor"
        assert resolve_command("mcp_reload_plan").name == "mcpreloadplan"
        assert resolve_command("mcp-reload-plan").name == "mcpreloadplan"
        assert resolve_command("capability-status").name == "capabilitystatus"
        assert resolve_command("cap_status").name == "capabilitystatus"
        assert resolve_command("capabilities").name == "capabilitystatus"
